...
<div class="container">
	...
	<!-- row min-height -->
	<div class="row">
	<div class="col-12" style="background:#fff; min-height:600px;">
			<div class="row">
												...
												<?php foreach($select_your_bike as $select_your_bikes): ?>
													...
													<br>
															<div class="container1">
																	<center>
																	<img class="image1" src="<?php echo base_url();?>assets/uploads/img_promotion_product/<?php echo $select_your_bikes->img1;?>" />
																	</center>
																	<div class="overlay">
															...
															<div class="row">
																	...
																	<div class="col-5"><img src="<?php echo base_url();?>img/promotion/cart.png" style="width:20px; float: right; margin-right: -5px; margin-top: 7px;"></div>
															</div>
															<br><br>
													</div>
													<?php endforeach; ?>
    ...
    <img src="<?php echo base_url();?>img/product/bat_footer.png"  width="100%" height="100px" alt=""/>
</body>
